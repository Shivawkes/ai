...
export default class Stream extends EventEmitter {
	...
	public send(typeOrPayload, payload?) {
		...
		// If the connection has not yet been established, it will be buffered and sent the next time a connection is established.
...
class Pool {
	...
	public dec() {
		...
		// When there are no more users on that connection
		if (this.users === 0) {
			// Since there is a possibility that the connection will be reused soon, wait a certain amount of time, and if no new users appear,
